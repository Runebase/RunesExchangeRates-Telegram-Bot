...
class altMarketRates {
  ...
  decode() {
this.content = `<a href='https://altmarkets.io/trading/runes${this.market}'>AltMarkets.io | RUNES/${this.market}</a>
<code>Buy price: ${parseFloat(this.data.ticker.buy).toFixed(8)} ${this.market}
